...
export function LoginFail({ descriptionFail }: loginFail) {
  return (
    <div className="flex fixed bg-red-500 flex-col lg:w-[25%] md:w-[25%] w-[75%] h-50 rounded-lg top-10 left-1/2 transform -translate-x-1/2 text-white justify-center items-center shadow-lg z-50 text-2xl gap-2">
